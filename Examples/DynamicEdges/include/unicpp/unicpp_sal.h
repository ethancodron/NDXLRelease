//----------------------------------------------\\
// C/C++ header file macroising SAL definitions	\\
// Copyright Ethan Codron 2025					\\
// All rights reserved.							\\
// ---------------------------------------------\\
// Includes sal.h if using MSVC compiler, else	\\
// macroises all SAL tokens.					\\
//----------------------------------------------\\
...
#include "unicpp_compiler.h"
	...
	#include <sal.h>
#else
	// Source: https://github.com/microsoft/omi/blob/master/Unix/common/linux/sal.h
	#if !defined(_In_)
	#define _In_
	#endif
